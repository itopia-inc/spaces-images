...
COPY runtimes/python/install_python_3-6_on_ubuntu_focal.sh /usr/share/dev-scripts/
RUN bash -c '/usr/share/dev-scripts/install_python_3-6_on_ubuntu_focal.sh'
